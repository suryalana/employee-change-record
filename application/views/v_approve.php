...
<body>
	...
	<div class="container-fluid">
		<form class="form-control" method='POST' action='c_index/simpan'>
			...
			<table class="table table-secondary table-striped table-hover">
				...
				<tr>
					...
					<td>
						<select class="form-select" name="ops_status">
							<option value="NULL">Choice..</option>
							<?php
								if (! empty($status)) {
									foreach ($status as $s) {
				...
				<tr>
					...
					<td><input class="form-control" type="text" name="txt_immediate"></td>
					<td><input class="form-control" type="text" name=""></td>
				</tr>
				<tr>
					<td><input class="form-check-input mt-0" type="checkbox"></td>
					<td>5. Designation *</td>
					<td><input class="form-control" type="text" name="txt_des"></td>
					<td><input class="form-control" type="text" name=""></td>
				</tr>
				<tr>
					<td><input class="form-check-input mt-0" type="checkbox"></td>
					<td>6. Basic Salary *</td>
					<td><input class="form-control" type="number" name="num_salary"></td>
					<td><input class="form-control" type="number" name=""></td>
				</tr>
				<tr>
					<td><input class="form-check-input mt-0" type="checkbox"></td>
					<td>7. Allowances Amount *</td>
					<td><input class="form-control" type="number" name="num_amount"></td>
					<td><input class="form-control" type="number" name=""></td>
				</tr>
				<tr>
					<td><input class="form-check-input mt-0" type="checkbox"></td>
					<td>8. Overtime Rate (Hourly Rate)</td>
					<td><input class="form-control" type="number" name="num_overtime"></td>
					<td><input class="form-control" type="number" name=""></td>
				</tr>
				<tr>
					<td><input class="form-check-input mt-0" type="checkbox"></td>
					<td>9. Others</td>
					<td><input class="form-control" type="text" name="txt_other"></td>
					<td><input class="form-control" type="text" name=""></td>
				</tr>
			</table>
			<br>
